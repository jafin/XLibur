...
public sealed partial class XLColor
{
    ...
    internal static XLColor FromArgb(uint argb)
    {
    ...
    internal static XLColor FromVmlColor(string colorType)
    {
        ...
        var paletteIndexStart = colorType.IndexOf('[');
    ...
    public static XLColor AntiqueWhite => FromColor(Color.AntiqueWhite);

    public static XLColor Aqua => FromColor(Color.Aqua);

    public static XLColor Aquamarine => FromColor(Color.Aquamarine);

    public static XLColor Azure => FromColor(Color.Azure);

    public static XLColor Beige => FromColor(Color.Beige);

    public static XLColor Bisque => FromColor(Color.Bisque);

    public static XLColor Black => FromColor(Color.Black);

    public static XLColor BlanchedAlmond => FromColor(Color.BlanchedAlmond);

    public static XLColor Blue => FromColor(Color.Blue);

    public static XLColor BlueViolet => FromColor(Color.BlueViolet);

    public static XLColor Brown => FromColor(Color.Brown);

    public static XLColor BurlyWood => FromColor(Color.BurlyWood);

    public static XLColor CadetBlue => FromColor(Color.CadetBlue);

    public static XLColor Chartreuse => FromColor(Color.Chartreuse);

    public static XLColor Chocolate => FromColor(Color.Chocolate);

    public static XLColor Coral => FromColor(Color.Coral);

    public static XLColor CornflowerBlue => FromColor(Color.CornflowerBlue);

    public static XLColor Cornsilk => FromColor(Color.Cornsilk);

    public static XLColor Crimson => FromColor(Color.Crimson);

    public static XLColor Cyan => FromColor(Color.Cyan);

    public static XLColor DarkBlue => FromColor(Color.DarkBlue);

    public static XLColor DarkCyan => FromColor(Color.DarkCyan);

    public static XLColor DarkGoldenrod => FromColor(Color.DarkGoldenrod);

    public static XLColor DarkGray => FromColor(Color.DarkGray);

    public static XLColor DarkGreen => FromColor(Color.DarkGreen);

    public static XLColor DarkKhaki => FromColor(Color.DarkKhaki);

    public static XLColor DarkMagenta => FromColor(Color.DarkMagenta);

    public static XLColor DarkOliveGreen => FromColor(Color.DarkOliveGreen);

    public static XLColor DarkOrange => FromColor(Color.DarkOrange);

    public static XLColor DarkOrchid => FromColor(Color.DarkOrchid);

    public static XLColor DarkRed => FromColor(Color.DarkRed);

    public static XLColor DarkSalmon => FromColor(Color.DarkSalmon);

    public static XLColor DarkSeaGreen => FromColor(Color.DarkSeaGreen);

    public static XLColor DarkSlateBlue => FromColor(Color.DarkSlateBlue);

    public static XLColor DarkSlateGray => FromColor(Color.DarkSlateGray);

    public static XLColor DarkTurquoise => FromColor(Color.DarkTurquoise);

    public static XLColor DarkViolet => FromColor(Color.DarkViolet);

    public static XLColor DeepPink => FromColor(Color.DeepPink);

    public static XLColor DeepSkyBlue => FromColor(Color.DeepSkyBlue);

    public static XLColor DimGray => FromColor(Color.DimGray);

    public static XLColor DodgerBlue => FromColor(Color.DodgerBlue);

    public static XLColor Firebrick => FromColor(Color.Firebrick);

    public static XLColor FloralWhite => FromColor(Color.FloralWhite);

    public static XLColor ForestGreen => FromColor(Color.ForestGreen);

    public static XLColor Fuchsia => FromColor(Color.Fuchsia);

    public static XLColor Gainsboro => FromColor(Color.Gainsboro);

    public static XLColor GhostWhite => FromColor(Color.GhostWhite);

    public static XLColor Gold => FromColor(Color.Gold);

    public static XLColor Goldenrod => FromColor(Color.Goldenrod);

    public static XLColor Gray => FromColor(Color.Gray);

    public static XLColor Green => FromColor(Color.Green);

    public static XLColor GreenYellow => FromColor(Color.GreenYellow);

    public static XLColor Honeydew => FromColor(Color.Honeydew);

    public static XLColor HotPink => FromColor(Color.HotPink);

    public static XLColor IndianRed => FromColor(Color.IndianRed);

    public static XLColor Indigo => FromColor(Color.Indigo);

    public static XLColor Ivory => FromColor(Color.Ivory);

    public static XLColor Khaki => FromColor(Color.Khaki);

    public static XLColor Lavender => FromColor(Color.Lavender);

    public static XLColor LavenderBlush => FromColor(Color.LavenderBlush);

    public static XLColor LawnGreen => FromColor(Color.LawnGreen);

    public static XLColor LemonChiffon => FromColor(Color.LemonChiffon);

    public static XLColor LightBlue => FromColor(Color.LightBlue);

    public static XLColor LightCoral => FromColor(Color.LightCoral);

    public static XLColor LightCyan => FromColor(Color.LightCyan);

    public static XLColor LightGoldenrodYellow => FromColor(Color.LightGoldenrodYellow);

    public static XLColor LightGray => FromColor(Color.LightGray);

    public static XLColor LightGreen => FromColor(Color.LightGreen);

    public static XLColor LightPink => FromColor(Color.LightPink);

    public static XLColor LightSalmon => FromColor(Color.LightSalmon);

    public static XLColor LightSeaGreen => FromColor(Color.LightSeaGreen);

    public static XLColor LightSkyBlue => FromColor(Color.LightSkyBlue);

    public static XLColor LightSlateGray => FromColor(Color.LightSlateGray);

    public static XLColor LightSteelBlue => FromColor(Color.LightSteelBlue);

    public static XLColor LightYellow => FromColor(Color.LightYellow);

    public static XLColor Lime => FromColor(Color.Lime);

    public static XLColor LimeGreen => FromColor(Color.LimeGreen);

    public static XLColor Linen => FromColor(Color.Linen);

    public static XLColor Magenta => FromColor(Color.Magenta);

    public static XLColor Maroon => FromColor(Color.Maroon);

    public static XLColor MediumAquamarine => FromColor(Color.MediumAquamarine);

    public static XLColor MediumBlue => FromColor(Color.MediumBlue);

    public static XLColor MediumOrchid => FromColor(Color.MediumOrchid);

    public static XLColor MediumPurple => FromColor(Color.MediumPurple);

    public static XLColor MediumSeaGreen => FromColor(Color.MediumSeaGreen);

    public static XLColor MediumSlateBlue => FromColor(Color.MediumSlateBlue);

    public static XLColor MediumSpringGreen => FromColor(Color.MediumSpringGreen);

    public static XLColor MediumTurquoise => FromColor(Color.MediumTurquoise);

    public static XLColor MediumVioletRed => FromColor(Color.MediumVioletRed);

    public static XLColor MidnightBlue => FromColor(Color.MidnightBlue);

    public static XLColor MintCream => FromColor(Color.MintCream);

    public static XLColor MistyRose => FromColor(Color.MistyRose);

    public static XLColor Moccasin => FromColor(Color.Moccasin);

    public static XLColor NavajoWhite => FromColor(Color.NavajoWhite);

    public static XLColor Navy => FromColor(Color.Navy);

    public static XLColor OldLace => FromColor(Color.OldLace);

    public static XLColor Olive => FromColor(Color.Olive);

    public static XLColor OliveDrab => FromColor(Color.OliveDrab);

    public static XLColor Orange => FromColor(Color.Orange);

    public static XLColor OrangeRed => FromColor(Color.OrangeRed);

    public static XLColor Orchid => FromColor(Color.Orchid);

    public static XLColor PaleGoldenrod => FromColor(Color.PaleGoldenrod);

    public static XLColor PaleGreen => FromColor(Color.PaleGreen);

    public static XLColor PaleTurquoise => FromColor(Color.PaleTurquoise);

    public static XLColor PaleVioletRed => FromColor(Color.PaleVioletRed);

    public static XLColor PapayaWhip => FromColor(Color.PapayaWhip);

    public static XLColor PeachPuff => FromColor(Color.PeachPuff);

    public static XLColor Peru => FromColor(Color.Peru);

    public static XLColor Pink => FromColor(Color.Pink);

    public static XLColor Plum => FromColor(Color.Plum);

    public static XLColor PowderBlue => FromColor(Color.PowderBlue);

    public static XLColor Purple => FromColor(Color.Purple);

    public static XLColor Red => FromColor(Color.Red);

    public static XLColor RosyBrown => FromColor(Color.RosyBrown);

    public static XLColor RoyalBlue => FromColor(Color.RoyalBlue);

    public static XLColor SaddleBrown => FromColor(Color.SaddleBrown);

    public static XLColor Salmon => FromColor(Color.Salmon);

    public static XLColor SandyBrown => FromColor(Color.SandyBrown);

    public static XLColor SeaGreen => FromColor(Color.SeaGreen);

    public static XLColor SeaShell => FromColor(Color.SeaShell);

    public static XLColor Sienna => FromColor(Color.Sienna);

    public static XLColor Silver => FromColor(Color.Silver);

    public static XLColor SkyBlue => FromColor(Color.SkyBlue);

    public static XLColor SlateBlue => FromColor(Color.SlateBlue);

    public static XLColor SlateGray => FromColor(Color.SlateGray);

    public static XLColor Snow => FromColor(Color.Snow);

    public static XLColor SpringGreen => FromColor(Color.SpringGreen);

    public static XLColor SteelBlue => FromColor(Color.SteelBlue);

    public static XLColor Tan => FromColor(Color.Tan);

    public static XLColor Teal => FromColor(Color.Teal);

    public static XLColor Thistle => FromColor(Color.Thistle);

    public static XLColor Tomato => FromColor(Color.Tomato);

    public static XLColor Turquoise => FromColor(Color.Turquoise);

    public static XLColor Violet => FromColor(Color.Violet);

    public static XLColor Wheat => FromColor(Color.Wheat);

    public static XLColor White => FromColor(Color.White);

    public static XLColor WhiteSmoke => FromColor(Color.WhiteSmoke);

    public static XLColor Yellow => FromColor(Color.Yellow);

    public static XLColor YellowGreen => FromColor(Color.YellowGreen);
    ...
    public static XLColor Transparent => FromColor(Color.Transparent);
}
